        ...
        {filtered.map((ep) => (
          <div
            ...
            className={classNames(
              ...
              {
                'bg-indigo-50 dark:bg-zinc-800/60 border-l-4 border-l-indigo-500':
                  ep.id === currentId,
            ...
            <div
              className={classNames(
                ...
                ep.id === currentId
                  ...
                  : 'bg-zinc-200 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-500 group-hover:text-indigo-600 dark:group-hover:text-indigo-400',
              )}
            >
              {ep.id === currentId ? (
                <PlayCircle size={20} />
